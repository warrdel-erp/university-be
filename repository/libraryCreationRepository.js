        ...
        include: [
            {
                ...
                include: [
                    ...
                    },
                    {
                        ...
                        attributes: ["student_id", "firstName", "middleName","lastName","fatherName","scholarNumber","email","phoneNumber"]
                    },
                    {
...
export async function getBooksIssuedToStudent(studentId) {
    try {
        const result = await model.libraryBookInventoryModel.findAll({
            ...
            attributes: [ "inventoryId", "libraryBookId", "barcode", "studentId", "issueDate", "dueDate", "status", "createdAt", "updatedAt" ],
            include: [
                {
                    model: model.libraryBookModel,
                    as: "bookDetails",
                    attributes: [
                        "libraryBookId", "title", "subtitle", "authors",
                        "publisher", "edition", "isbn", "issn"
                    ]
                },
                {
                    model: model.studentModel,
