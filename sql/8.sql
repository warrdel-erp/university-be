...
CREATE TABLE job_settings (
    job_setting_id INT AUTO_INCREMENT PRIMARY KEY,
    university_id INT NOT NULL,
    institute_id INT NOT NULL,
    ...
    updated_at DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
    deleted_at DATETIME NULL,
    CONSTRAINT fk_js_uni FOREIGN KEY (university_id) REFERENCES university(university_id),
    CONSTRAINT fk_js_inst FOREIGN KEY (institute_id) REFERENCES institute(institute_id),
    CONSTRAINT fk_js_createdby FOREIGN KEY (created_by) REFERENCES users(user_id),
    CONSTRAINT fk_js_updatedby FOREIGN KEY (updated_by) REFERENCES users(user_id)
);
...
CREATE TABLE jobs (
    ...
    updated_at DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
    deleted_at DATETIME NULL,
    CONSTRAINT fk_jobs_university FOREIGN KEY (university_id) REFERENCES university(university_id),
    CONSTRAINT fk_jobs_institute FOREIGN KEY (institute_id) REFERENCES institute(institute_id),
    CONSTRAINT fk_jobs_job_setting FOREIGN KEY (job_setting_id) REFERENCES job_settings(job_setting_id),
    CONSTRAINT fk_jobs_department FOREIGN KEY (sub_account_id) REFERENCES sub_account(sub_account_id),
    CONSTRAINT fk_jobs_course FOREIGN KEY (course_id) REFERENCES course(course_id),
    CONSTRAINT fk_jobs_subject FOREIGN KEY (subject_id) REFERENCES subject(subject_id),
    CONSTRAINT fk_jobs_employee FOREIGN KEY (employee_id) REFERENCES employee(employee_id),
    CONSTRAINT fk_jobs_created_by FOREIGN KEY (created_by) REFERENCES users(user_id),
    CONSTRAINT fk_jobs_updated_by FOREIGN KEY (updated_by) REFERENCES users(user_id)
);