...
/**
 * Drop legacy tables once before new create migrations (testing reset).
 * No rename needed — asset_issue is removed here, then creates add new tables.
 */
...
module.exports = {
  async up(queryInterface) {
    ...
    try {
      ...
      await dropTableIfExists(queryInterface, 'asset', transaction);
