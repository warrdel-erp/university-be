...
export async function addAmcVendor(req, res) {
  try {
    const row = await amcVendorService.addAmcVendor(req.body);
...
export async function getAllAmcVendor(req, res) {
  try {
    const result = await amcVendorService.listAmcVendors(req.query);
...
export async function getSingleAmcVendorDetails(req, res) {
  try {
    ...
    const row = await amcVendorService.getSingleAmcVendor(amcVendorId);
    if (!row) {
...
export async function updateAmcVendor(req, res) {
  try {
    ...
    const row = await amcVendorService.updateAmcVendor(amcVendorId, req.body);
...
export async function deleteAmcVendor(req, res) {
  try {
    const { amcVendorId } = req.query;
    await amcVendorService.deleteAmcVendor(amcVendorId);
...
export async function previewAmcVendorCode(req, res) {
  try {
    ...
    const row = await amcVendorService.previewVendorCode(vendorName, assetCategoryId);
