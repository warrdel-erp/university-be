...
export const deleteClassSectionTerm = async (req, res) => {
  try {
    ...
    const result = await classSectionServices.deleteClassSectionTerm(classSectionTermId);
    return SuccessResponse(res, 200, "Class section term deleted successfully", result);
  } catch (error) {
