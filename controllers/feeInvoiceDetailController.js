...
export async function addFeeInvoiceDetails(req, res) {
  ...
  try {
    ...
    const feeInvoiceDetails = await FeeInvoiceDetailsCreation.addFeeInvoiceDetails(
      req.body,
      createdBy,
      updatedBy
    );
...
export async function getAllFeeInvoiceDetails(req, res) {
  try {
    const FeeInvoiceDetails = await FeeInvoiceDetailsCreation.getFeeInvoiceDetailsDetails();
...
export async function getSingleFeeInvoiceDetails(req, res) {
  try {
    ...
    const feeInvoiceDetails = await FeeInvoiceDetailsCreation.getSingleFeeInvoiceDetails(
      feeInvoiceDetailsId
    );
...
export async function updateFeeInvoiceDetails(req, res) {
  try {
    ...
    const updatedBy = req.user.userId;
    const updatedFeeInvoiceDetails = await FeeInvoiceDetailsCreation.updateFeeInvoiceDetails(
      feeInvoiceDetailsId,
      req.body,
      updatedBy
    );
