...
router.get('/', userAuth, checkAccess(PERMISSIONS.ELECTIVE_SUBJECT_NEW.value, 'electiveSubject'), getAllElectiveSubject);

router.get('/single' ,userAuth, checkAccess(PERMISSIONS.ELECTIVE_SUBJECT_NEW.value, 'electiveSubject'), getSingleElectiveSubjectDetails);
