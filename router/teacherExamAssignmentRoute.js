...
router.delete("/:teacherExamAssignmentId", userAuth, checkAccess(PERMISSIONS.EXAM_ASSIGN_TEACHER_DELETE.value, 'teacherExamAssignment'), validate({ params: assignmentParamsSchema }), removeTeacherFromExam);
