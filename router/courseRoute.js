...
const getSingleCourseQuerySchema = z.object({
  courseId: z.preprocess(
    ...
    z.union([
      ...
      z.number().int().positive({ message: "courseId is required" }),
    ]),
  ),
});
...
router.get(
  ...
  validate({ query: classSectionsGroupedSchema }),
  courseController.getTermsWithClassSections,
);
...
router.delete(
  "/:courseId",
  userAuth,
  checkAccess(PERMISSIONS.COURSES_DELETE.value, null),
