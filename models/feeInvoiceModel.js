...
const feeInvoiceModel = sequelize.define(
    'fee_invoice',
    {
        feeInvoiceId: {
    ...
    {
        tableName: 'fee_invoice__deprecated',
        timestamps: true,
        paranoid: true
    }
);

feeInvoiceModel.scopeConfig = { university: false, institute: false, academicYear: false };
