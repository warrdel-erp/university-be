...
const studentCorsAddressModel = sequelize.define(
    'student_cor_address',
    {
        studentCorAddressId: {
...
studentCorsAddressModel.scopeConfig = { university: false, institute: false, academicYear: false };

export default studentCorsAddressModel;
