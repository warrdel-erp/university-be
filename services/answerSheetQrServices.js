...
export async function generateBulkAnswerSheetQr(count, instituteId, universityId) {
  ...
  const unusedCount = await answerSheetQrRepository.countUnusedByInstitute(instituteId, universityId);
  ...
  const created = await answerSheetQrRepository.bulkCreateAnswerSheetQr(payload);
...
export async function mapAnswerSheetQr(qr, studentId, examScheduleId, instituteId, universityId) {
  ...
  if (studentId) {
    const student = await answerSheetQrRepository.getScopedStudent(studentId, instituteId, universityId);
    if (!student) {
...
export async function getAnswerSheetQrDetailById(id, instituteId, universityId) {
  const row = await answerSheetQrRepository.getAnswerSheetQrById(id, instituteId, universityId);
