...
export async function getTeacherSubjectMappingService(employeeId, universityId, instituteId, role, subjectId, sessionId) {
  return await getTeacherSubjectMapping(employeeId, universityId, instituteId, role, subjectId, sessionId)
};

export async function getTeacherSectionMappingService(employeeId, universityId, acedmicYearId, instituteId, role, sessionId) {
  return await getTeacherSectionMapping(employeeId, universityId, acedmicYearId, instituteId, role, sessionId)
};
